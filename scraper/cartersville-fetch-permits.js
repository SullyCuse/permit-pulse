...
const BASE_URL = 'https://api-east.viewpointcloud.com/v2/cartersvillega/records';
const PORTAL_BASE = 'https://cartersvillega.portal.opengov.com/records';

const RECORD_TYPES = [
  { id: 6430, name: 'Commercial Building Permit' },
  { id: 6427, name: 'Residential Building Permit' },
  { id: 6442, name: 'Demolition Permit' },
  { id: 6352, name: 'Electrical Permit' },
  { id: 6349, name: 'Gas Permit' },
  { id: 6354, name: 'Mechanical Permit' },
  { id: 6353, name: 'Plumbing Permit' },
  { id: 6440, name: 'Retaining Wall Permit' },
  { id: 6443, name: 'Swimming Pool Permit' },
  { id: 6437, name: 'Sign Permit' },
  { id: 6359, name: 'Fire Alarm System Permit' },
  { id: 6360, name: 'Fire Suppression System Permit' },
  { id: 6361, name: 'Fire Sprinkler System Permit' },
];

const HEADERS = {
  'Accept': 'application/json',
  'Origin': 'https://cartersvillega.portal.opengov.com',
  'Referer': 'https://cartersvillega.portal.opengov.com/',
...
async function fetchNewPermits(lastTimestampMs = 0) {
  const since = lastTimestampMs
    ...
    : 'beginning';
  console.log(`[Cartersville] Fetching permits since ${since}...`);
  ...
  console.log(`[Cartersville] ${unique.length} total active, ${newRecords.length} new since ${since}`);
