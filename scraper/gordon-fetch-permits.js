...
const BASE_URL = 'https://api-east.viewpointcloud.com/v2/countyofgordonga/records';
const PORTAL_BASE = 'https://countyofgordonga.portal.opengov.com/records';

// Construction-related record types (excludes business licenses, rezoning/variance,
// plat reviews, code complaints). IDs from /record_types.
const RECORD_TYPES = [
  { id: 6437, name: 'Commercial Building Permit' },
  { id: 6450, name: 'Residential Building Permit' },
  { id: 6471, name: 'Remodel/Repair Permit' },
  { id: 6446, name: 'Mobile Home Permit' },
  { id: 6457, name: 'Plumbing Permit' },
  { id: 6438, name: 'Electrical Permit' },
  { id: 6439, name: 'HVAC Permit' },
  { id: 6440, name: 'Gas Permit' },
  { id: 6441, name: 'Pool Permit' },
  { id: 6459, name: 'Deck/Porch Permit' },
  { id: 6464, name: 'Retaining Walls Permit' },
  { id: 6469, name: 'Portable Storage Buildings Permit' },
  { id: 6470, name: 'Sign Permit' },
  { id: 6465, name: 'Fire Sprinkler Permit' },
  { id: 6467, name: 'Fire Alarm Permit' },
];

const HEADERS = {
  'Accept': 'application/json',
  'Origin': 'https://countyofgordonga.portal.opengov.com',
  'Referer': 'https://countyofgordonga.portal.opengov.com/',
...
async function fetchNewPermits(lastTimestampMs = 0) {
  const since = lastTimestampMs
    ...
    : 'beginning';
  console.log(`[Gordon County] Fetching permits since ${since}...`);
  ...
  console.log(`[Gordon County] ${unique.length} total active, ${newRecords.length} new since ${since}`);
