...
const BASE_URL = 'https://api-east.viewpointcloud.com/v2/glynncountyga/records';
const PORTAL_BASE = 'https://glynncountyga.portal.opengov.com/records';

const RECORD_TYPES = [
  { id: 6447, name: 'Residential Building Permit' },
  { id: 6451, name: 'Commercial Building Permit' },
  { id: 6452, name: 'Shell Permit' },
  { id: 6453, name: 'Residential Accessory Building' },
  { id: 6464, name: 'Commercial Accessory Building' },
  { id: 6455, name: 'Pool Permit Application' },
  { id: 6469, name: 'Demolition' },
  { id: 6492, name: 'Foundation Only' },
  { id: 6461, name: 'Electrical Permit' },
  { id: 6544, name: 'Plumbing Permit' },
  { id: 6466, name: 'Mechanical Permit' },
  { id: 6349, name: 'Gas Permit' },
];

const HEADERS = {
  'Accept': 'application/json',
  'Origin': 'https://glynncountyga.portal.opengov.com',
  'Referer': 'https://glynncountyga.portal.opengov.com/',
...
async function fetchNewPermits(lastTimestampMs = 0) {
  const since = lastTimestampMs
    ...
    : 'beginning';
  console.log(`[Glynn County] Fetching permits since ${since}...`);
  ...
  console.log(`[Glynn County] ${unique.length} total active, ${newRecords.length} new since ${since}`);
