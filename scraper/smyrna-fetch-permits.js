...
const BASE_URL = 'https://api-east.viewpointcloud.com/v2/smyrnaga/records';
const PORTAL_BASE = 'https://smyrnaga.portal.opengov.com/records';

const RECORD_TYPES = [
  { id: 6475, name: 'Residential Building Permit' },
  { id: 6485, name: 'Fire Marshal - Fire/Safety System Permit' },
  { id: 6437, name: 'Sign Permit' },
  { id: 6445, name: 'Tree Removal Permit' },
];

const HEADERS = {
  'Accept': 'application/json',
  'Origin': 'https://smyrnaga.portal.opengov.com',
  'Referer': 'https://smyrnaga.portal.opengov.com/',
...
async function fetchNewPermits(lastTimestampMs = 0) {
  const since = lastTimestampMs
    ...
    : 'beginning';
  console.log(`[Smyrna] Fetching permits since ${since}...`);
  ...
  console.log(`[Smyrna] ${unique.length} total active, ${newRecords.length} new since ${since}`);
