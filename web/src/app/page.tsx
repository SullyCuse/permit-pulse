    ...
    <div className="min-h-screen bg-white">
        ...
        <div className="max-w-5xl mx-auto px-6">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-10">
            {[
              ...
              { step: '2', title: 'We monitor for you', desc: 'Our system checks all 24 Georgia markets for new filings automatically — Monday, Wednesday, and Friday.' },
        ...
        <div className="max-w-4xl mx-auto px-6 text-center">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6 max-w-2xl mx-auto">
            <PricingCard
              ...
              features={['All 24 Georgia markets', 'Full permit feed dashboard', 'Up to 3 zip codes']}
              highlight={false}
            />
            <PricingCard
              name="Pro"
              ...
              features={['All 24 Georgia markets', 'Email digest Mon, Wed & Fri', 'Unlimited zip codes']}
              highlight={true}
            />
          </div>
        </div>
      ...
      <section className="hero-pattern py-16">
        <div className="max-w-5xl mx-auto px-6">
          <div className="text-center mb-8">
            ...
            <p className="text-gray-500 text-sm">We cover 24 Georgia counties and cities. Click an area to see what's being built.</p>
          </div>
      ...
      <section className="py-20 text-center px-6 hero-pattern">
        ...
        <p className="text-gray-500 mb-8 max-w-xl mx-auto">
          Join contractors, investors, and agents already tracking permits across 24 Georgia markets — from Metro Atlanta to the coast.
        </p>
        <Link
          href="/login"
