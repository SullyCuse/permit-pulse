            ...
            {[
              {
                ...
                a: 'We pull directly from the official public records of Hall, Gwinnett, Forsyth, DeKalb, Bryan, Cherokee, Effingham, Fayette, Henry, Coweta, Glynn, Gordon, Clayton, Barrow, Jackson, Houston, Dawson, Morgan, and Bulloch County — and Atlanta, Savannah, Alpharetta, Johns Creek, Augusta, Sandy Springs, Smyrna, Cartersville, Austell, Gainesville, Oakwood, Marietta, LaGrange, Roswell, Lawrenceville, Perry, Flowery Branch, and Dallas — updated Monday, Wednesday, and Friday.',
              },
              {
              ...
              },
              {
                ...
                a: 'Yes — we recently added Clayton, Barrow, Jackson, Houston, Dawson, Gordon, Morgan, and Bulloch County, plus Roswell, Lawrenceville, Perry, Flowery Branch, and Dallas, and are actively expanding. Pro subscribers get early access to new areas.',
              },
            ].map(item => (
