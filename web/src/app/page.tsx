    ...
    <div className="min-h-screen bg-white">
      ...
      <section className="max-w-4xl mx-auto px-6 pt-20 pb-16 text-center">
        <div className="inline-block bg-blue-50 text-blue-700 text-xs font-semibold px-3 py-1 rounded-full mb-6 uppercase tracking-wide">
          Hall, Gwinnett &amp; Forsyth County, GA · Updated every Monday
        </div>
        <h1 className="text-5xl font-bold text-gray-900 leading-tight">
          Know about new permits<br />before your competition
        </h1>
        <p className="mt-6 text-xl text-gray-500 max-w-2xl mx-auto">
          Permit Pulse tracks every building permit filed in Hall, Gwinnett, and Forsyth County and sends you instant alerts when new filings match your zip codes — so you can be first on the job.
        </p>
        ...
        <div className="max-w-4xl mx-auto px-6">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8 text-center">
            {[
              ...
              { step: '2', title: 'We monitor for you', desc: 'Our system checks Hall, Gwinnett, and Forsyth County for new filings every Monday morning automatically.' },
      ...
      <section id="pricing" className="py-20 max-w-4xl mx-auto px-6">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8 max-w-2xl mx-auto">
          <PricingCard
            ...
            features={['Hall, Gwinnett & Forsyth County', 'Weekly digest email', 'Up to 3 zip codes', 'Permit feed dashboard']}
            highlight={false}
          />
          <PricingCard
            name="Pro"
            ...
            features={['Hall, Gwinnett & Forsyth County', 'Instant alerts', 'Unlimited zip codes', 'Priority support']}
            highlight={true}
          />
        </div>
      </section>
            ...
            {[
              {
                ...
                a: 'We pull directly from Hall, Gwinnett, and Forsyth County\'s official public records, updated every Monday morning.',
              },
              {
              ...
              },
              {
                ...
                a: 'Yes — Jackson and more are on the roadmap. Pro subscribers get early access.',
              },
            ].map(item => (
      ...
      <section className="py-20 text-center px-6">
        ...
        <p className="text-gray-500 mb-8">Join contractors and investors already tracking permits across Hall, Gwinnett, and Forsyth County.</p>
