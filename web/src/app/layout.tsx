...
export const metadata: Metadata = {
  ...
  description: "Get instant alerts when new building permits are filed in Hall, Gwinnett, Forsyth, DeKalb, Bryan, and Cherokee County — and the cities of Atlanta, Savannah, Alpharetta, Johns Creek, Sandy Springs, Augusta, Gainesville, and Oakwood — GA.",
};
