...
export const metadata: Metadata = {
  ...
  description: "Get instant alerts when new building permits are filed across 21 Georgia markets — Hall, Gwinnett, Forsyth, DeKalb, Bryan, Cherokee, Effingham, Fayette, and Henry County — and Atlanta, Savannah, Alpharetta, Johns Creek, Sandy Springs, Augusta, Smyrna, Cartersville, Austell, Gainesville, Oakwood, and Marietta, GA.",
};
