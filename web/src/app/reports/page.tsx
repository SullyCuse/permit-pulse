...
export const metadata: Metadata = {
  ...
  description: 'Monthly building permit activity reports across 38 Georgia counties and cities — new construction trends by area and month, from official records.',
}
