...
export const metadata: Metadata = {
  ...
  description: 'Monthly building permit activity reports for Hall, Gwinnett, Forsyth, DeKalb, Bryan, Cherokee, Effingham, Fayette, Henry, Coweta, Cobb, and Glynn County — and Atlanta, Savannah, Alpharetta, Johns Creek, Augusta, Sandy Springs, Smyrna, Cartersville, Austell, Gainesville, Oakwood, Marietta, and LaGrange, Georgia.',
}
    ...
    <div className="min-h-screen bg-white">
      ...
      <section className="max-w-4xl mx-auto px-6 pt-16 pb-12 text-center">
        ...
        <p className="mt-4 text-lg text-gray-500 max-w-2xl mx-auto">
          Monthly permit data across Hall, Gwinnett, Forsyth, DeKalb, Bryan, Cherokee, Effingham, Fayette, Henry, Coweta, Cobb, and Glynn County — and Atlanta, Savannah, Alpharetta, Johns Creek, Augusta, Sandy Springs, Smyrna, Cartersville, Austell, Gainesville, Oakwood, Marietta, and LaGrange — pulled directly from official county sources.
        </p>
        {totalPermits > 0 && (
